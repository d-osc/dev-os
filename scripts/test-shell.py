...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='devos-shell-test-') as temporary:
        ...
        assert count(bar, mint, 0, 120) > 30, 'green >_ prompt of the start button missing'
        assert count(bar, light, 30, 110) > 30, 'white DEVOS lettering missing'
        ...
        checks.append('green-outlined start button (>_ DEVOS in white), separator, '
                      'left-anchored pinned icon, tray with wifi + red badge, '
