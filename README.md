...
หน้า login แบบกราฟิก ยืนยันกับ /etc/shadow แล้วเข้า desktop shell เป็นผู้ใช้รายคน)
และ `server` (headless — tty1 เป็นหน้าจอ login console และ dev-shell ปฏิเสธการทำงาน)
ดูค่าปัจจุบันด้วย `dev mode` และสลับ
